 ...
 */
export function calculateNextRunAt(recurrenceType, recurrenceDay, recurrenceTime) {
    const now = new Date();
    ...
    switch (recurrenceType) {
        ...
        case 'monthly': {
            ...
            if (nextRun.getTime() <= now.getTime()) {
                ...
                thisMonth.setDate(Math.min(dayOfMonth, new Date(thisMonth.getFullYear(), thisMonth.getMonth() + 1, 0).getDate()));
