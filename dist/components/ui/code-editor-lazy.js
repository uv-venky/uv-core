...
const CodeEditorLoading = () => (_jsx("div", { className: "flex h-full w-full items-center justify-center bg-muted/50", children: _jsx("div", { className: "h-8 w-8 animate-spin rounded-full border-4 border-primary border-t-transparent" }) }));
/**
