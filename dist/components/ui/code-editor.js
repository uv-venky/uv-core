...
export function CodeEditor(props) {
    ...
    const handleEditorMount = (editor, monaco) => {
        ...
        if ((language === 'typescript' || language === 'javascript') && monaco.typescript) {
            const defaults = language === 'typescript' ? monaco.typescript.typescriptDefaults : monaco.typescript.javascriptDefaults;
    ...
    return (_jsx(MonacoEditor, { ...props, onMount: handleEditorMount, theme: resolvedTheme === 'dark' ? 'vercel-dark' : 'light' }));
}
