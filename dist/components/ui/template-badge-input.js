...
export function getDisplayTextForStaticTemplate(template, extraOptions) {
    if (!extraOptions?.length)
        return template;
    const found = extraOptions.find((o) => o.value === template);
 ...
 */
export function TemplateBadgeInput({ value = '', onChange, placeholder, disabled, className, id, extraTemplateOptions, }) {
    ...
    }, [internalValue, isFocused, nodes, placeholder, saveCursorPosition, restoreCursorPosition, extraTemplateOptions]);
