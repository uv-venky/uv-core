...
export function renderResetPasswordPage(options = {}) {
    const title = options.title ?? 'Reset Password';
    ...
    const apiPath = options.apiPath ?? '/api/auth/reset-password/request';
        ...
        <div id="request-view">
          ...
          <form id="reset-form">
            <div class="form-group">
              ...
              <input id="username" name="username" type="text" autocomplete="username" class="form-control" required autofocus />
            </div>

            <div class="form-group">
              <label for="email" class="form-label">Email</label>
              <input id="email" name="email" type="email" autocomplete="email" class="form-control" required />
            </div>

            <button type="submit" id="submit-btn" class="btn btn-primary" style="margin-top: 1.5rem;">Send Reset Link</button>
            
            <div class="footer-links-container">
              <a href="${escapeHtml(loginPath)}" class="text-link">
          ...
          try {
            ...
            card.innerHTML = [
              '<div class="success-panel">',
                '<h2 class="success-title">Reset Password</h2>',
            ...
            showError(error && error.message ? error.message : 'Failed to request password reset');
