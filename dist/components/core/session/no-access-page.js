...
export function NoAccessPage({ reportReadyToLoadingTracker = false, signOut: signOutProp }) {
    ...
    return (_jsx("div", { className: "flex min-h-screen flex-col items-center justify-center px-4 text-center", children: _jsxs("div", { className: "mx-auto max-w-md space-y-6", children: [_jsxs("div", { className: "space-y-2", children: [_jsx("h1", { className: "font-bold text-3xl text-muted-foreground tracking-tighter", children: "No Access" }), _jsx("h2", { className: "font-bold text-muted-foreground text-xl tracking-tight", children: "You do not have any roles assigned to access this application" }), _jsx("p", { className: "text-muted-foreground", children: `Please sign out and contact your administrator to get access to this application and sign in again.` })] }), _jsxs(Button, { activityId: "404-back-home", size: "lg", className: "gap-2", onClick: async () => {
