 ...
 */
export function SecureHomePage({ noAccessPath = '/no-access' }) {
    ...
    return (_jsxs("div", { className: "flex h-full w-full items-center justify-center gap-2 bg-background", children: [_jsx(Loader2, { className: "h-4 w-4 animate-spin" }), "Loading..."] }));
}
//# sourceMappingURL=secure-home-page.js.map