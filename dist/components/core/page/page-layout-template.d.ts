...
export default function PageLayoutTemplate<T extends object>({ store, filterStartContent, filterEndContent, hideColumnsMenu, hideFilters, hidePagination, smartSearchColumns, tableColumns, pageId, itemId, title, subTitle, icon, editForm, editFormFooterContent, getDefaultRow, addNewButtonText, toolbarContent, loadingRows, searchOnBlur, defaultVisibleColumnOrder, rowClickToEdit, popupWidth, popupHeight, popupBodyClassName, editFormLayout, disableHeaderFilters: disableHeaderFiltersProp, updateFilters, stickyFilters, allowDelete, handleSave, onSaveSuccess, keepOpen, showExportButton, exportFilename, exportIncludeMetadata, editFormSubTitle, tableVariant, }: Props<T>): import("react/jsx-runtime").JSX.Element;
export declare function PaginationSection<T extends object>({ table, store, hideRowsPerPageSelector, }: {
    table: Table<T>;
    store: Store<T>;
