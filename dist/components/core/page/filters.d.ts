...
export default function TableFilters<T extends object>({ store, table, columns, pageId, itemId, border, roundedCorners, disableSavedSearches, stickyFilters, searchOnBlur, updateFilters, }: {
    store: Store<T>;
    table?: Table<T>;
    columns: Column<T>[];
    pageId: string;
