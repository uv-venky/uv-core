...
export function SearchButton(props) {
    ...
    return (_jsx(Button, { className: "flex-grow-0", onClick: (e) => {
            e.stopPropagation();
            dispatch({ type: 'doSearch', reason: 'search-click' });
        }, "data-tip": "Search", variant: "ghost", size: "icon", "aria-label": "Search", "data-testid": "search-button", children: props.isBusy ? _jsx(WaveDots, { active: true }) : _jsx(Search, {}) }));
}
