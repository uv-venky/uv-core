...
declare function getDefaultOperator(a: Column<any, any>): "on" | "is" | "not" | "empty" | "notempty" | "nct" | "like" | "sw" | "ew" | "hasall" | "hasany" | "notany" | "in" | "nin" | "eq" | "ne" | "null" | "notnull" | "gt" | "gte" | "lt" | "lte" | "bn" | "after" | "before" | "inthefuture" | "inthepast" | "last14days" | "last28days" | "last7days" | "next14days" | "next28days" | "next7days" | "noton" | "onorafter" | "onorbefore" | "thismonth" | "thisquarter" | "thisweek" | "thisyear" | "today" | "tomorrow" | "yesterday" | "istrue";
export type { BOOLEAN_OPS_KEY_TYPE, DATE_OPS_KEY_TYPE, NUMBER_OPS_KEY_TYPE, OPS_KEY_TYPE, SELECT_OPS_KEY_TYPE, STRING_OPS_KEY_TYPE, YN_TF_OPS_KEY_TYPE, };
