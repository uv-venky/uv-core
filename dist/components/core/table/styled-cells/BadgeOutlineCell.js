...
export function BadgeOutlineCell({ attributeCode, mono = true, className, feedbackMask, row, }) {
    ...
    return (_jsx(Cell, { attributeCode: attributeCode, store: store, rowId: row.id, feedbackMask: feedbackMask, children: _jsx(Badge, { variant: "outline", className: cn(mono && 'font-mono', className), children: stringValue }) }));
}
