...
const getBrowserInfo = (userAgent) => {
    ...
    if (userAgent.includes('Chrome'))
        return { name: 'Chrome', icon: SiGooglechrome };
    ...
    return useMemo(() => {
        const columns = [
            ...
            },
            {
                ...
                size: 130,
                header: (props) => {
                    return _jsx(HeaderCell, { ...props, type: "Date", store: store, accessorKey: "lastAccessedAt", title: "Status" });
                },
                cell: StatusCell,
            },
            {
                ...
                size: 180,
                header: (props) => {
                    return _jsx(HeaderCell, { ...props, type: "Date", store: store, accessorKey: "expiresAt", title: "Expires At" });
                },
                cell: (props) => {
            ...
            },
            {
                ...
                size: 180,
                header: (props) => {
                    return _jsx(HeaderCell, { ...props, type: "Date", store: store, accessorKey: "signedInAt", title: "Signed In At" });
                },
                cell: (props) => {
            ...
            },
            {
                ...
                size: 180,
                header: (props) => {
                    return (_jsx(HeaderCell, { ...props, type: "Date", store: store, accessorKey: "lastAccessedAt", title: "Last Accessed At" }));
                },
                cell: (props) => {
            ...
            },
            {
                ...
                size: 180,
                header: (props) => {
                    return _jsx(HeaderCell, { ...props, type: "Date", store: store, accessorKey: "signedOutAt", title: "Signed Out At" });
                },
                cell: (props) => {
            ...
            },
            {
                ...
                size: 160,
                header: (props) => {
                    return _jsx(HeaderCell, { ...props, type: "Text", store: store, accessorKey: "ipAddress", title: "Ip Address" });
                },
                cell: IpAddressCell,
            },
            {
                ...
                size: 140,
                header: (props) => {
                    return _jsx(HeaderCell, { ...props, type: "Text", store: store, accessorKey: "userAgent", title: "User Agent" });
                },
                cell: UserAgentCell,
            },
        ];
...
function UserAgentCell(props) {
    ...
    return (_jsxs(Badge, { variant: "outline", className: "gap-1.5 border-border/50 bg-muted/30 font-normal text-muted-foreground", "data-tip": userAgent, children: [_jsx(Icon, { className: "size-3" }), browser.name] }));
}
function IpAddressCell(props) {
    ...
    return (_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Globe, { className: "size-3.5 text-muted-foreground" }), _jsx("span", { className: "font-mono text-sm", children: ipAddress })] }));
}
function DateToNowCell(props) {
    ...
    return (_jsxs("div", { className: "space-y-0.5", children: [_jsx("div", { className: "font-medium text-sm", children: format(date, 'MMM d, h:mm a') }), _jsx("div", { className: "text-muted-foreground text-xs", children: formatDistanceToNow(date, { addSuffix: true }) })] }));
}
function StatusCell() {
    const store = useCurrentStore();
    ...
    return (_jsxs(Badge, { variant: "outline", className: cn('gap-1.5 border font-normal', config.bgColor, config.color), children: [_jsx(Icon, { className: "size-3" }), config.label] }));
}
