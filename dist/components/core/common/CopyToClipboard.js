...
export const CLIPBOARD_MORPH_ICON_PATHS = {
    default: {
        color: 'gray',
...
export default function CopyToClipboard(props) {
    ...
    return (_jsx(Button, { variant: "ghost", size: "icon", "data-tip": props.tip ?? 'Copy to clipboard', onClick: handleClick, disabled: isLoading || isAnimating, className: props.class, children: _jsx("svg", { width: "24px", height: "24px", viewBox: "0 0 24 24", children: _jsx("path", { ref: pathRef, d: CLIPBOARD_MORPH_ICON_PATHS.default.d, fill: CLIPBOARD_MORPH_ICON_PATHS.default.color }) }) }));
}
