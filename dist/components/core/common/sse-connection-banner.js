...
export function SSEConnectionBanner() {
    ...
    return (_jsx("div", { className: cn('fixed top-0 left-1/2 z-50 flex -translate-x-1/2 items-center justify-center transition-all duration-300', shouldShow ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0'), children: _jsxs(Alert, { variant: "warning", className: "flex max-w-2xl items-center gap-3 rounded-t-none border-yellow-500/50 border-t-0 bg-yellow-400 dark:bg-yellow-950/20", children: [_jsx(WifiOff, { className: "size-4 shrink-0 text-yellow-600 dark:text-yellow-400" }), _jsx(AlertDescription, { className: "flex-1 text-yellow-900 dark:text-yellow-100", children: getStatusMessage() })] }) }));
}
//# sourceMappingURL=sse-connection-banner.js.map