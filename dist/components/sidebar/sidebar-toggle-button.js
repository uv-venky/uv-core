...
export function SidebarToggleButton() {
    ...
    return (_jsx("div", { className: cn('absolute top-1/2 -right-4 z-50 -translate-y-1/2 transition-all duration-300 ease-in-out', 'opacity-0', 'group-hover/sidebar:opacity-100'), "data-sidebar": "toggle-button", children: _jsx(SidebarTrigger, { className: "h-7 w-7", onClick: () => {
