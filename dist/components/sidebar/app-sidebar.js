...
function AppSidebar({ ...props }) {
    ...
    return (_jsxs(Sidebar, { collapsible: "icon", ...props, className: cn('group/sidebar', props.className), children: [_jsxs(SidebarHeader, { className: "relative flex h-16 items-center justify-center", children: [_jsx(SidebarToggleButton, {}), activeTeam && _jsx(TeamSwitcher, { teams: teams, activeTeam: activeTeam, setActiveTeam: setActiveTeam })] }), _jsx(SidebarContent, { children: activeTeam &&
                    (activeTeam.teamPath === '/command-center' ? (_jsxs(_Fragment, { children: [_jsx("div", { className: "shrink-0", children: _jsx(OneLevelNav, { team: activeTeam, title: activeTeam.menuTitle ?? activeTeam.name }) }), _jsx("div", { className: "flex min-h-0 flex-1 flex-col overflow-hidden", children: DynamicSidebarContent && _jsx(DynamicSidebarContent, { activeTeam: activeTeam }) }), _jsx("div", { className: "shrink-0", children: activeTeam.modules.map((module) => (_jsx(ModuleNav, { module: module }, module.title))) })] })) : (_jsxs("div", { className: cn('scrollbar-thin scrollbar-thumb-sidebar-accent scrollbar-track-sidebar-border', 'flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto'), children: [_jsx(OneLevelNav, { team: activeTeam, title: activeTeam.menuTitle ?? activeTeam.name }), DynamicSidebarContent && _jsx(DynamicSidebarContent, { activeTeam: activeTeam }), activeTeam.modules.map((module) => (_jsx(ModuleNav, { module: module }, module.title)))] }))) }), _jsx(SidebarFooter, { children: _jsx(NavUser, {}) })] }));
}
