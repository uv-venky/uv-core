...
export const NewPasswordPage = ({ title = 'Change Password', brandName = 'Stitchmate', logo = DEFAULT_LOGO_SVG, backgroundUrl = '', apiPath = '/api/auth/reset-password/change', loginPath = '/login', }) => {
    return (_jsxs("html", { lang: "en", children: [_jsxs("head", { children: [_jsx("meta", { charSet: "utf-8" }), _jsx("meta", { name: "viewport", content: "width=device-width, initial-scale=1" }), _jsx("title", { children: `${title} | ${brandName}` }), _jsx("link", { rel: "preconnect", href: "https://fonts.googleapis.com" }), _jsx("link", { rel: "preconnect", href: "https://fonts.gstatic.com", crossOrigin: "anonymous" }), _jsx("link", { href: "https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600&family=Outfit:wght@300;400;500;600&display=swap", rel: "stylesheet" }), _jsx("style", { dangerouslySetInnerHTML: { __html: `
        ...
        ` } })] }), _jsxs("body", { children: [_jsx("div", { className: "bg-container" }), _jsx("header", { children: logo && typeof logo === 'string' ? (_jsx("div", { className: "logo-container", dangerouslySetInnerHTML: { __html: logo } })) : (_jsx("div", { className: "logo-container", children: logo })) }), _jsx("main", { children: _jsx("div", { className: "login-box", children: _jsxs("div", { className: "card", id: "form-card", children: [_jsx("div", { id: "error-alert", className: "error-banner", role: "alert" }), _jsxs("div", { id: "change-view", children: [_jsx("h1", { className: "form-title", children: "Change your password" }), _jsxs("form", { id: "change-form", children: [_jsxs("div", { className: "form-group", children: [_jsx("label", { htmlFor: "password", className: "form-label", children: "New Password" }), _jsx("input", { id: "password", name: "password", type: "password", autoComplete: "new-password", className: "form-control", required: true, autoFocus: true })] }), _jsxs("div", { className: "form-group", children: [_jsx("label", { htmlFor: "confirm-password", className: "form-label", children: "Confirm Password" }), _jsx("input", { id: "confirm-password", name: "confirm-password", type: "password", autoComplete: "new-password", className: "form-control", required: true })] }), _jsxs("ul", { className: "req-list", children: [_jsxs("li", { id: "req-length", className: "req-item", children: [_jsx("span", { className: "req-dot", children: _jsx("svg", { className: "checkmark", viewBox: "0 0 10 10", children: _jsx("polyline", { points: "2 5.5 4 7.5 8 3" }) }) }), "Password is at least 8 characters long"] }), _jsxs("li", { id: "req-uppercase", className: "req-item", children: [_jsx("span", { className: "req-dot", children: _jsx("svg", { className: "checkmark", viewBox: "0 0 10 10", children: _jsx("polyline", { points: "2 5.5 4 7.5 8 3" }) }) }), "Contains at least one uppercase letter"] }), _jsxs("li", { id: "req-lowercase", className: "req-item", children: [_jsx("span", { className: "req-dot", children: _jsx("svg", { className: "checkmark", viewBox: "0 0 10 10", children: _jsx("polyline", { points: "2 5.5 4 7.5 8 3" }) }) }), "Contains at least one lowercase letter"] }), _jsxs("li", { id: "req-number", className: "req-item", children: [_jsx("span", { className: "req-dot", children: _jsx("svg", { className: "checkmark", viewBox: "0 0 10 10", children: _jsx("polyline", { points: "2 5.5 4 7.5 8 3" }) }) }), "Contains at least one number"] }), _jsxs("li", { id: "req-match", className: "req-item", children: [_jsx("span", { className: "req-dot", children: _jsx("svg", { className: "checkmark", viewBox: "0 0 10 10", children: _jsx("polyline", { points: "2 5.5 4 7.5 8 3" }) }) }), "Passwords match"] })] }), _jsx("button", { type: "submit", id: "submit-btn", className: "btn btn-primary", style: { marginTop: '1.5rem' }, disabled: true, children: "Change Password" })] })] })] }) }) }), _jsxs("footer", { children: ["\u00A9 ", new Date().getFullYear(), " ", brandName, ". All rights reserved."] }), _jsx("script", { dangerouslySetInnerHTML: { __html: `
          (function () {
...
export function renderNewPasswordPage(options = {}) {
    const markup = renderToStaticMarkup(_jsx(NewPasswordPage, { ...options }));
    return `<!DOCTYPE html>\n${markup}`;
}
//# sourceMappingURL=new-password-page.js.map