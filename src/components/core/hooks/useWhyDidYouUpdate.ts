 ...
 */
function getChangedPaths(prev: unknown, curr: unknown, basePath: string, depth: number): ChangedPath[] {
 ...
 */
export default function useWhyDidYouUpdate(name: string, props: Record<string, unknown>, printKeysOnly = false) {
