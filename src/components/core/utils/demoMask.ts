...
export function setDemoMask(value: boolean) {
  enabled = value;
}
 ...
 */
export function isDemoMask(): boolean {
 ...
 */
export function isVisualRegressionMode(): boolean {
  return typeof window !== 'undefined' && window.__WAYVO_DEMO_MASK__ === true;
}
 ...
 */
export function maskString(value?: string): string | undefined {
  if (value == null || !isDemoMask()) {
    return value;
  }
  // VR mode: constant length
 ...
 */
export function maskValue(value: number): string | number {
  if (value == null || !isDemoMask()) {
    return value;
  }
  // VR mode: constant length
 ...
 */
export function maskDate(formattedDate: string): string {
 ...
 */
export function maskChartDate(value: string, formatStr = 'MMM d'): string {
  if (!isDemoMask()) {
 ...
 */
export function maskChartNumber(value: number): string {
  if (!isDemoMask()) {
