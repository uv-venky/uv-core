...
export type TemplateExtraOption = { value: string; label: string };
...
export function getDisplayTextForStaticTemplate(
  template: string,
  extraOptions: TemplateExtraOption[] | undefined,
): string {
  if (!extraOptions?.length) return template;
  ...
  return (
    <>
      ...
      <TemplateAutocomplete
        ...
        staticOptions={extraTemplateOptions?.map((o: TemplateExtraOption) => ({ template: o.value, label: o.label }))}
      />
    </>
  );
}
