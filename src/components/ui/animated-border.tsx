...
export const AnimatedBorder = ({ className }: AnimatedBorderProps) => {
  return (
    <>
      ...
      `}} />
      <div className={cn('pointer-events-none absolute inset-0 animate-border-mask rounded-[inherit]', className)}>
      ...
      <div
        className={cn('pointer-events-none absolute inset-0 rounded-[inherit] border-2 border-blue-500/10', className)}
      />
    </>
  );
};
