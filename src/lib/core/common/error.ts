...
/** Stable across bundles/realms so instanceof still works when duplicate @wayvo-ai/core copies are loaded. */
export const USER_ERROR_BRAND = Symbol.for('wayvo.UserError');
